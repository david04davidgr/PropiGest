...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['idMantenimiento'])) {
    $idMantenimiento = intval($_POST['idMantenimiento']); //Convertir a entero para mayor seguridad
    ...
    try {
        ...
        echo json_encode(["success" => true, "message" => "Mantenimiento eliminada correctamente"]);
    } catch (Exception $e) {
